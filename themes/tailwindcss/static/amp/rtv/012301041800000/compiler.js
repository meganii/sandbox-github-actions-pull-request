(() => {
  ...
  function createNode(container, strings) {
    ...
    devAssert(Array.isArray(strings) || hasOwn(strings, "raw"), "Invalid template strings array");
    if (self.trustedTypes && self.trustedTypes.createPolicy) {
      const policy = self.trustedTypes.createPolicy("static-template#createNode", {
        createHTML: function(unused) {
          return strings[0];
        }
      });
      container.innerHTML = policy.createHTML("ignored");
    } else {
